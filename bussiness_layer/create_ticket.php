...
if ($_FILES["fileToUpload"]["size"] > 500000) {
  echo "Osprapravedlňujem sa ale váš súbor je príliš veľký.";
  $uploadOk = 0;
}
...
if ($uploadOk == 0) {
    echo "Ospravedlňujeme sa, ale nepodarilo sa nahrať váš súbor.Presmerujeme vás na hlavnú stránku...";
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    echo "Ospravedlňujeme sa nastala chyba s vaším súborom. Presmerujeme vás na hlavnú stránku...";
    header("refresh:1;redirect.php");
  }
}
